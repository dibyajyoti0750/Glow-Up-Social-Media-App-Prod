  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="w-full max-w-4xl mx-auto my-8 px-8">
        ...
        {/* Tabs */}
        <div className="flex flex-wrap justify-between items-center border border-gray-100 rounded-lg py-1 shadow-sm mb-6">
          {dataArray.map((tab) => (
            <button
        ...
        {/* Counts */}
        <div className="mb-6 flex flex-col max-w-xl p-6 shadow-sm rounded-lg">
