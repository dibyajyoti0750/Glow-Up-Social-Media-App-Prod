export default function SkeletonLoader() {
  return (
    <div className="flex flex-col items-center space-y-10 my-10 w-full h-full">
      <div className="flex flex-col bg-gray-100 w-[70%] h-full animate-pulse rounded-xl p-4 gap-4">
